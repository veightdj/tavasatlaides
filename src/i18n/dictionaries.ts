...
export const dict = {
  lv: {
    ...
    home: {
      heroTitle: "Atklāj labākās atlaides Rīgā un Jūrmalā",
      heroSub: "Vietējie veikali, restorāni un pakalpojumi — visas aktuālās akcijas vienuviet, uz kartes vai sarakstā.",
