...
export const dict = {
  ...
  ru: {
    ...
    forMerchants: { title: "Магазинам", body: "Размещайте свои акции бесплатно и привлекайте местных покупателей на карте.", cta: "Регистрация бесплатно", benefits: ["Бесплатная публикация акций", "Появитесь на карте в Риге", "Аудитория на трёх языках (LV/EN/RU)", "Отслеживайте просмотры и сохранения"] },
