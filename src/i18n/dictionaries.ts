...
export const dict = {
  lv: {
    ...
    deals: {
      ...
      shareTitle: "Dalies", shareWhatsapp: "WhatsApp", shareFacebook: "Facebook", shareCopy: "Kopēt saiti", shareNative: "Citur...", shareCopied: "Saite nokopēta",
  ...
  en: {
    ...
    deals: {
      ...
      shareTitle: "Share", shareWhatsapp: "WhatsApp", shareFacebook: "Facebook", shareCopy: "Copy link", shareNative: "More...", shareCopied: "Link copied",
  ...
  ru: {
    ...
    deals: {
      ...
      saved: "Сохранено",
      viewStore: "Магазин",
      shareTitle: "Поделиться", shareWhatsapp: "WhatsApp", shareFacebook: "Facebook", shareCopy: "Скопировать ссылку", shareNative: "Ещё...", shareCopied: "Ссылка скопирована",
