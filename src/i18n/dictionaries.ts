...
export const dict = {
  ...
  en: {
    ...
    home: {
      heroTitle: "Discover the best deals in Riga & Jurmala",
      heroSub: "Local shops, restaurants and services — every active discount in one place, on the map or in a list.",
