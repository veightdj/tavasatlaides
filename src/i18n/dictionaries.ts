...
export const dict = {
  ...
  en: {
    ...
    map: { title: "Map" },
    about: { title: "About TavasAtlaides", body: "TavasAtlaides is a local deals marketplace for Jurmala and Riga. We connect shoppers with discounts from nearby stores." },
    forMerchants: { title: "For merchants", body: "Post your promotions for free and reach local shoppers on the map.", cta: "Sign up free", benefits: ["Free to publish your deals", "Appear on the map in Riga & Jurmala", "Reach trilingual audience (LV/EN/RU)", "Track views and saves per ad"] },
  ...
  ru: {
    ...
    home: {
      ...
      heroSub: "Находи скидки, купоны и местные предложения в Риге, Юрмале и по всей Латвии.",
    ...
    map: { title: "Карта" },
    about: { title: "О TavasAtlaides", body: "TavasAtlaides — местный маркетпейс скидок в Юрмале и Риге. Мы соединяем покупателей с акциями ближайших магазинов." },
    forMerchants: { title: "Магазинам", body: "Размещайте свои акции бесплатно и привлекайте местных покупателей на карте.", cta: "Регистрация бесплатно", benefits: ["Бесплатная публикация акций", "Появитесь на карте в Риге и Юрмале", "Аудитория на трёх языках (LV/EN/RU)", "Отслеживайте просмотры и сохранения"] },
