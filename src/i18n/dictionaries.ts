...
export const dict = {
  lv: {
    ...
    deals: {
      ...
      nearError: "Neizdevās noteikt tavu atrašanās vietu. Atļauj piekļuvi atrašanās vietai pārlūka iestatījumos vai ievadi adresi manuāli.",
      distanceKm: "km",
      awayLabel: "attālumā",
      nearMe: "Tuvumā",
      radius: "Rādiuss",
  ...
  en: {
    ...
    deals: {
      ...
      nearError: "Couldn't detect your location. Allow location access in your browser settings or enter an address manually.",
      distanceKm: "km",
      awayLabel: "away",
      nearMe: "Near me",
      radius: "Radius",
  ...
  ru: {
    ...
    deals: {
      ...
      nearError: "Не удалось определить ваше местоположение. Разрешите доступ к геолокации в настройках браузера или укажите адрес вручную.",
      distanceKm: "км",
      awayLabel: "от вас",
      nearMe: "Рядом",
      radius: "Радиус",
