...
function SettingsPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-6 md:py-12 space-y-8">
      ...
      <section className="space-y-3">
        <h2 className="text-sm font-semibold uppercase tracking-wider text-muted-foreground flex items-center gap-2">
          <Bell className="h-4 w-4" /> Notifications & location
        </h2>
        <Link
          to="/settings/notifications"
          className="flex items-center justify-between rounded-2xl border bg-card p-4 hover:bg-muted/40 transition"
        >
